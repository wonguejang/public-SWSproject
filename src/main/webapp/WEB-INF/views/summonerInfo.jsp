				                        ...
				                        <div class="detail_info">
				                            <div>
				                                ...
				                                <div class="match-spell">
				                                    <img src="${matchList.get(10).spell1}">
				                                    <img src="${matchList.get(10).spell2}">
				                                </div>
				                                <div class="match-rune">
				                                    <img src="${matchList.get(10).mainRuneUrl}">
				                                    <img src="${matchList.get(10).subRuneUrl}">
				                                </div>
				                                <div class="match-kda">
				                            ...
				                            <div class="match_item_build">
				                                <img src="https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/${matchList.get(10).matchItem1}.png" onerror="this.onerror=null; this.src='https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/9289.png'">
				                                <img src="https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/${matchList.get(10).matchItem2}.png" onerror="this.onerror=null; this.src='https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/9289.png'">
				                                <img src="https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/${matchList.get(10).matchItem3}.png" onerror="this.onerror=null; this.src='https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/9289.png'">
				                                <img src="https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/${matchList.get(10).matchItem4}.png" onerror="this.onerror=null; this.src='https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/9289.png'">
				                                <img src="https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/${matchList.get(10).matchItem5}.png" onerror="this.onerror=null; this.src='https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/9289.png'">
				                                <img src="https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/${matchList.get(10).matchItem6}.png" onerror="this.onerror=null; this.src='https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/9289.png'">
				                                <img src="https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/${matchList.get(10).matchItem7}.png" onerror="this.onerror=null; this.src='https://ddragon.leagueoflegends.com/cdn/15.9.1/img/item/9289.png'">
				                            </div>
				                        </div>
				                        <div class="damage_container">
											<canvas id="redChart${status.index}" width="360" height="360" style="width: 120px !important; height: 120px !important;"></canvas>
											<canvas id="blueChart${status.index}" width="360" height="360" style="width: 120px !important; height: 120px !important;"></canvas>		
										    <script>

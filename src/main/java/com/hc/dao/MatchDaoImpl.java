...
//------------------------------------------------------------------------------------------------------------------------	
	...
	public void MergeSummonerInfo(SummonerInfoDto dto) {
		System.out.println("summonerChampId : "+dto.getSummonerChampId());
	...
	@Override
	public int getOnlyWinnerTeam(String MatchId) {
		int winnerTeam = sqlSession.selectOne("matchMapper.getOnlyWinnerTeam", MatchId);
		return winnerTeam;
	}
	
	@Override
	public int getOnlyMatchRuneType(int Rune) {
		return sqlSession.selectOne("matchMapper.getOnlyMatchRuneType", Rune);
	}
}

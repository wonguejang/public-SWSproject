...
//	    System.out.println("이제 곧 터짐 터짐");
	...
	@Override
	public MatchSpellDto getMatchSpell(String MatchId, String SummonerId) {
		Map<String, Object> params = new HashMap<>();
	    params.put("MatchId", MatchId);
	    params.put("mdSummonerId", SummonerId);
		return sqlSession.selectOne("WindowMapper.MatchSpell", params); 
	}
	
	@Override
	public MatchRunesDto getMatchRune(String MatchId, String SummonerId) {
		Map<String, Object> params = new HashMap<>();
		params.put("MatchId", MatchId);
		params.put("SummonerId", SummonerId);
		MatchRunesDto dto;
		dto = sqlSession.selectOne("WindowMapper.MatchRune", params);
		System.out.println(dto.getMatchMainRune1());
		return dto;
	}
}	
